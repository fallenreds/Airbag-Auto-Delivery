...
def build_document():
    ...
    add_table(doc,
        ...
        [
            ...
            ["Відправити фото з оплатою 🖼",
             "Запускає процес надсилання скриншоту платежу. "
             "Клієнт відправляє фото, яке одразу пересилається адміністратору."],
            ["Статус замовлень 📦",
    ...
    add_table(doc,
        ...
        [
            ...
            ["Довго не сплачували замовлення 📆",
             "Показує список замовлень, які не були сплачені вчасно."],
            ["Так, переглянути несплачені замовлення ⏰",
             "Фільтрує та показує прострочені несплачені замовлення."],
            ["Створити оголошення 🖼",
    ...
    add_table(doc,
        ...
        [
            ...
            ["Відправити фото з оплатою 🖼",
             "Адмін вводить ID замовлення і надсилає фото підтвердження оплати. "
             "Фото пересилається всім адміністраторам."],
    ...
    add_table(doc,
        ...
        [
            ...
            ["NewPaymentData", "order_id → photo", "Надсилання фото підтвердження оплати"],
    ...
    add_table(doc,
        ...
        [
            ...
            ["get_no_paid_orders(bot, admin_list)",
             "кожну годину (3600 с)",
             "Отримує список прострочених несплачених замовлень. "
             "Надсилає нагадування клієнтам (максимум 2 рази, лічильник remember_count). "
             "Повідомляє адмінів про кількість несплачених замовлень."],
    ...
    add_table(doc,
        ...
        [
            ...
            ["unpaid_overdue(limit)", "GET /api/v2/orders/unpaid-overdue/",
             "Прострочені несплачені замовлення", "✅ Працює"],
            ["update_no_paid_remember_count(order_id, remember_count)",
             "PATCH /api/v2/orders/{id}/",
             "Оновлення лічильника нагадувань про несплату", "✅ Працює"],
